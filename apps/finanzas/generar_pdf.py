...
def pdf_create(ruta_template, output_path, rutacss='static/assets/css/volt.min.css', page_size='Letter', m_top='0.5in', m_right='0.5in', m_bottom='0.5in', m_left='0.5in'):
